        ...
        <div class="col-sm-6">
            ...
            <form action="/admin/save" method="post">
                ...
                <fieldset class="form-group">
                    ...
                    <input type="text" required class="form-control" name="screenName" value="${adminInfo.screenName}" id="name" placeholder="姓名">
                    <small class="text-muted">管理员姓名.</small>
                </fieldset>
                <fieldset class="form-group">
                    <label for="exampleInputEmail1">邮箱地址</label>
                    <input type="email" required class="form-control" id="exampleInputEmail1" name="email" value="${adminInfo.email}" placeholder="Enter email">
                </fieldset>
                <fieldset class="form-group">
